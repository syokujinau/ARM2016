...
void I2C0_Init(void)
{
    ...
    /* Slave address : 0x15 */
    I2C0->ADDR0 = (I2C0->ADDR0 & ~I2C_ADDR0_ADDR_Msk) | (g_au8MasterAddr[0] << I2C_ADDR0_ADDR_Pos);
    /* Slave address : 0x35 */
    I2C0->ADDR1 = (I2C0->ADDR1 & ~I2C_ADDR1_ADDR_Msk) | (g_au8MasterAddr[1] << I2C_ADDR1_ADDR_Pos);
    /* Slave address : 0x55 */
    I2C0->ADDR2 = (I2C0->ADDR2 & ~I2C_ADDR2_ADDR_Msk) | (g_au8MasterAddr[2] << I2C_ADDR2_ADDR_Pos);
    /* Slave address : 0x75 */
    I2C0->ADDR3 = (I2C0->ADDR3 & ~I2C_ADDR3_ADDR_Msk) | (g_au8MasterAddr[3] << I2C_ADDR3_ADDR_Pos);
