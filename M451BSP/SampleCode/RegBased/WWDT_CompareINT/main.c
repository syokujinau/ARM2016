 ...
 * @return      None
 *
 * @details     The WWDT_IRQHandler is default IRQ of WWDT, declared in startup_M451Series.s.
 */
...
void SYS_Init(void)
{
    ...
    CLK->CLKSEL1 = CLK_CLKSEL1_UARTSEL_PLL | CLK_CLKSEL1_WWDTSEL_PCLK0_DIV2048;
