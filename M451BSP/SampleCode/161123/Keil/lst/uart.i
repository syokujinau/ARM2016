...
void UART_ClearIntFlag(UART_T* uart , uint32_t u32InterruptFlag)
{
    ...
    if(u32InterruptFlag & (0x1ul << (16)))    
    {
        uart->INTSTS = (0x1ul << (16));
    }

    if(u32InterruptFlag & (0x1ul << (17)))    
    {
        uart->INTSTS = (0x1ul << (17));
    }
...
void UART_DisableInt(UART_T*  uart, uint32_t u32InterruptFlag)
{
    ...
    if(uart == ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000)))
        NVIC_DisableIRQ(UART0_IRQn);
    else if(uart == ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000)))
        NVIC_DisableIRQ(UART1_IRQn);
    else if(uart == ((UART_T *) (((0x40000000UL) + 0x00040000) + 0x32000)))
...
void UART_Open(UART_T* uart, uint32_t u32baudrate)
{
    ...
    uint32_t u32ClkTbl[4] = {(12000000UL), 0, (32768UL), (22118400UL)};
    uint32_t u32Baud_Div = 0;

     
    u8UartClkSrcSel = (((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL1 & (0x3ul << (24))) >> (24);

     
    u8UartClkDivNum = (((CLK_T *) ((0x40000000UL) + 0x00200))->CLKDIV0 & (0xful << (8))) >> (8);
