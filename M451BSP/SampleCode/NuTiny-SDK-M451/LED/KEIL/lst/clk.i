...
void CLK_DisableCKO(void)
{
    ...
    CLK_DisableModuleClock(((((1) & 0x03) << 30)|((((6)) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((3) & 0x07) << 25)|(((28) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));
}
...
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKOCTL = (0x1ul << (4)) | u32ClkDiv | (u32ClkDivBy1En << (5));

     
    CLK_EnableModuleClock(((((1) & 0x03) << 30)|((((6)) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((3) & 0x07) << 25)|(((28) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));

     
    CLK_SetModuleClock(((((1) & 0x03) << 30)|((((6)) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((3) & 0x07) << 25)|(((28) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)), u32ClkSrc, 0);
}
...
void CLK_PowerDown(void)
{
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200))->PWRCTL |= ((0x1ul << (7)) | (0x1ul << (8)));
...
void CLK_Idle(void)
{
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200))->PWRCTL &= ~(0x1ul << (7));
...
uint32_t CLK_GetHXTFreq(void)
{
    if(((CLK_T *) ((0x40000000UL) + 0x00200))->PWRCTL & (0x1ul << (0)))
        return (12000000UL);
    else
        return 0;
}
...
uint32_t CLK_GetLXTFreq(void)
{
    if(((CLK_T *) ((0x40000000UL) + 0x00200))->PWRCTL & (0x1ul << (1)))
        return (32768UL);
    else
        return 0;
}
...
uint32_t CLK_GetPCLK0Freq(void)
{
    ...
    if(((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 & (0x1ul << (6)))
...
{
    SystemCoreClockUpdate();
    if(((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 & (0x1ul << (7)))
        return SystemCoreClock / 2;
    else
        return SystemCoreClock;
}
...
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    ...
    u32HIRCSTB = ((CLK_T *) ((0x40000000UL) + 0x00200))->STATUS & (0x1ul << (4));
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200))->PWRCTL |= (0x1ul << (2));
    CLK_WaitClockReady((0x1ul << (4)));
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 |= (0x7ul << (0));
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKDIV0 &= (~(0xful << (0)));
...
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200))->PWRCTL |= (0x1ul << (2));
    CLK_WaitClockReady((0x1ul << (4)));
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 = (((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 & (~(0x7ul << (0)))) | (0x07UL<<(0));

     
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKDIV0 = (((CLK_T *) ((0x40000000UL) + 0x00200))->CLKDIV0 & (~(0xful << (0)))) | u32ClkDiv;

     
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 = (((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 & (~(0x7ul << (0)))) | u32ClkSrc;
...
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    if((((u32ModuleIdx) >>10) & 0xff) != 0x0)
    {
        ...
        u32div = (uint32_t)&((CLK_T *) ((0x40000000UL) + 0x00200))->CLKDIV0 + (((((u32ModuleIdx) >>18) & 0x3)) * 4);
    ...
    if((((u32ModuleIdx) >>25) & 0x7) != 0x0)
    {
        ...
        u32sel = (uint32_t)&((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 + (((((u32ModuleIdx) >>28) & 0x3)) * 4);
...
void CLK_SetSysTickClockSrc(uint32_t u32ClkSrc)
{
    ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 = (((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 & ~(0x7ul << (3))) | u32ClkSrc;
...
void CLK_EnableXtalRC(uint32_t u32ClkMask)
{
    ((CLK_T *) ((0x40000000UL) + 0x00200))->PWRCTL |= u32ClkMask;
}
...
void CLK_EnableModuleClock(uint32_t u32ModuleIdx)
{
    *(volatile uint32_t *)((uint32_t)&((CLK_T *) ((0x40000000UL) + 0x00200))->AHBCLK + ((((u32ModuleIdx) >>30) & 0x3) * 4))  |= 1 << (((u32ModuleIdx) >>0 ) & 0x1f);
}
...
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if(u32PllClkSrc == 0x00000000UL)
    {
        ...
        ((CLK_T *) ((0x40000000UL) + 0x00200))->PWRCTL |= (0x1ul << (0));
    ...
    ((CLK_T *) ((0x40000000UL) + 0x00200))->PLLCTL = u32CLK_SRC | (u32NO << 14) | ((u32MinNR - 2) << 9) | (u32MinNF - 2);
...
lexit:
    ...
    if(u32PllClkSrc == 0x00000000UL)
        ...
        ((CLK_T *) ((0x40000000UL) + 0x00200))->PLLCTL = (0x00080000UL | (((4)-2)<<9) | ((52)-2) | 0xC000UL);  
...
{    
    ...
    while((((CLK_T *) ((0x40000000UL) + 0x00200))->STATUS & u32ClkMask) != u32ClkMask)
    {
        if(i32TimeOutCnt-- <= 0)
            return 0;
    }
