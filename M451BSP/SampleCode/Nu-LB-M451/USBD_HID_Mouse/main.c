...
void EnableCLKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    CLK->CLKOCTL = CLK_CLKOCTL_DIV1EN_Msk | u32ClkDiv;
...
void SYS_Init(void)
{
    ...
    SYS->GPD_MFPL = SYS_GPD_MFPL_PD6MFP_UART0_RXD | SYS_GPD_MFPL_PD1MFP_UART0_TXD | SYS_GPD_MFPL_PD6MFP_CLKO;

    /* Enable CLKO(PB8) for monitor HCLK. CLKO = HCLK/8 Hz*/
    EnableCLKO((2 << CLK_CLKSEL1_CLKOSEL_Pos), 2);
}
