#line 1 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_IrDA_NEC.c"
...
#line 2 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_IrDA_NEC.c"
...
#line 3 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_IrDA_NEC.c"
...
#line 4 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_IrDA_NEC.c"
...
volatile    uint8_t             IR_LDC_Ready = 0;   
volatile    uint8_t             IR_CTC_Ready = 0;   
volatile    uint8_t             IR_CTC0 = 0;        
volatile    uint8_t             IR_CTC1 = 0;        
volatile    uint8_t             IR_DAC = 0;         
volatile    uint8_t             IR_DAB = 0;         
...
void IrDa_NEC_Rx(uint32_t u32Time)
{
    ...
    else if(IR_State == 1)
    {
        ...
        if((u32Time >= (13460 * (1 - 0.04))) && (u32Time <= (13460 * (1 + 0.04))))
        {
            IR_LDC_Ready = 1;       
            IR_State++;
        }
    ...
    else if((IR_State >= 2 && IR_State < 10) && (IR_LDC_Ready == 1))
    {
        IR_State++;
        IR_CTC0 = IR_CTC0 >> 1;
        if((u32Time >= (1120 * (1 - 0.04))) && (u32Time <= (1120 * (1 + 0.04))))          
            IR_CTC0 &= 0x7f;
        else if((u32Time >= (2236 * (1 - 0.04))) && (u32Time <= (2236 * (1 + 0.04)))) 
            IR_CTC0 |= 0x80;
        else
            IR_State = 0;
    }
...
{
    uint32_t TDR1_tmp;
    TDR1_tmp = 0xFFFF - (*(volatile uint32_t *) (&((((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)))->FCAPDAT0) + 2 * (5)));
    PWM_ClearCaptureIntFlag(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), 5, (0x100UL));
    IrDa_NEC_Rx(TDR1_tmp);
}

#line 137 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_IrDA_NEC.c"
...
void Mark(uint8_t N)
{
    ...
    PWM_EnableOutput(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), (0x8UL));
    CLK_SysTickDelay(560 * N);
    PWM_DisableOutput(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), (0x8UL));
...
void IrDA_NEC_TxRx_Init(void)
{
    ...
    ((SYS_T *) ((0x40000000UL) + 0x00000))->GPD_MFPL = ((SYS_T *) ((0x40000000UL) + 0x00000))->GPD_MFPL & (~(0xful << (28)));
    ((SYS_T *) ((0x40000000UL) + 0x00000))->GPD_MFPL |= (6ul << (28));
    ((SYS_T *) ((0x40000000UL) + 0x00000))->GPE_MFPL = ((SYS_T *) ((0x40000000UL) + 0x00000))->GPE_MFPL & (~(0xful << (12)));
    ((SYS_T *) ((0x40000000UL) + 0x00000))->GPE_MFPL |= (6ul << (12));


     
    CLK_EnableModuleClock(((((2UL) & 0x03) << 30)|((((16)) & 0x1f) << 0)| (((2) & 0x03) << 28)|(((1) & 0x07) << 25)|(((0) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));

     
    CLK_SetModuleClock(((((2UL) & 0x03) << 30)|((((16)) & 0x1f) << 0)| (((2) & 0x03) << 28)|(((1) & 0x07) << 25)|(((0) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)), (0x1UL<<(0)), 0);

     
    SYS_ResetModule(((0x8<<24) | (16) ));

     
    PWM_ConfigOutputChannel(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), 3, 38000, 30);

     
    PWM_Start(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), (0x8UL));




     
    PWM_ConfigCaptureChannel(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), 5, 1000, 0);

     
    PWM_EnableCaptureInt(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), 5, (0x100UL));

     
    NVIC_EnableIRQ(PWM0P2_IRQn);

     
    PWM_Start(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), (0x20UL));

     
    ((GPIO_T *) ((0x40000000UL) + 0x040C0))->SMTEN |= (0x1ul << (7));

     
    PWM_EnableCapture(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), (0x20UL));

     
    ((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000))->CAPCTL |= (0x1ul << (29));
