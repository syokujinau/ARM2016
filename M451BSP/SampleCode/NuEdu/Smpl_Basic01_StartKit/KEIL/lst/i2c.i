...
void I2C_Close(I2C_T *i2c)
{
    ...
    if((uint32_t)i2c == (((0x40000000UL) + 0x00040000) + 0x40000))
    {
        ((SYS_T *) ((0x40000000UL) + 0x00000))->IPRST1 |= (0x1ul << (8));
        ((SYS_T *) ((0x40000000UL) + 0x00000))->IPRST1 &= ~(0x1ul << (8));
    }
    else if((uint32_t)i2c == (((0x40000000UL) + 0x00040000) + 0x41000))
    {
        ((SYS_T *) ((0x40000000UL) + 0x00000))->IPRST1 |= (0x1ul << (9));
        ((SYS_T *) ((0x40000000UL) + 0x00000))->IPRST1 &= ~(0x1ul << (9));
    }
...
void I2C_SMBusTimeout(I2C_T *i2c, uint32_t ms, uint32_t u32Pclk)
{
    ...
    i2c->BUSTOUT = (((ms * u32Pclk_kHz) / (16 * 1024 * 4)) - 1) & 0xFF; 
}
...
void I2C_SMBusClockLoTimeout(I2C_T *i2c, uint32_t ms, uint32_t u32Pclk)
{
    ...
    i2c->TOCTL |= (0x1ul << (2));
    i2c->CLKTOUT = (((ms * u32Pclk_kHz) / (16 * 1024 * 4)) - 1) & 0xFF; 
}
