#line 1 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_Buzzer.c"
...
#line 2 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_Buzzer.c"
...
#line 3 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_Buzzer.c"
...
#line 4 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_Buzzer.c"

void Open_Buzzer(void)
{
     
    ((SYS_T *) ((0x40000000UL) + 0x00000))->GPC_MFPH &= ~(0xful << (24));
    ((SYS_T *) ((0x40000000UL) + 0x00000))->GPC_MFPH |= (6ul << (24));
...
void Write_Buzzer(unsigned Enable, unsigned  int Frequence, unsigned int Duty)
{
    ...
    PWM_ConfigOutputChannel(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 5, Frequence, Duty);

    
    PWM_Start(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 1 << 5);
    if(Enable == 1)
         
        PWM_EnableOutput(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 1 << 5);
    else
        PWM_DisableOutput(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 1 << 5);
}
