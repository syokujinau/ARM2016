...
#line 13 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M451Series\\Source\\system_M451Series.c"
...
uint32_t gau32ClkSrcTbl[] = {(12000000UL), (32768UL), 0, (10000UL), 0, 0, 0, (22118400UL)};
...
void SystemCoreClockUpdate(void)              
{
    ...
    u32ClkSrc = ((CLK_T *) ((0x40000000UL) + 0x00200))->CLKSEL0 & (0x7ul << (0));
    ...
    u32HclkDiv = (((CLK_T *) ((0x40000000UL) + 0x00200))->CLKDIV0 & (0xful << (0))) + 1;
...
void SystemInit(void)
{
    ...
    if((((SYS_T *) ((0x40000000UL) + 0x00000))->PDID >> 12) == 0x945)
    {
        (*((vu32 *) (((0x40000000UL) + 0x00000)+0x14))) |= 0x00000080;
    }
     
    ((CLK_T *) ((0x40000000UL) + 0x00200))->PWRCTL &= ~(0x1ul << (12));
    SYS_LockReg();


#line 101 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\M451Series\\Source\\system_M451Series.c"
