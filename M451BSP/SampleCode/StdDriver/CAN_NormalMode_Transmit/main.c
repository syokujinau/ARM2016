 ...
 * @brief
 *           Implement transmit message in Normal mode.
 *           This sample code needs to work with CAN_NormalMode_Receive.
 * @note
...
void Test_NormalMode_Tx(CAN_T *tCAN)
{
    ...
    printf("Use Message Object No.0 to send STD_ID:0x7FF, Data[07,FF]\n");
    printf("Use Message Object No.1 to send EXT_ID:0x12345, Data[01,23,45]\n");
    printf("Use Message Object No.3 to send EXT_ID:0x7FF01, Data[A1,B2,C3,D4]\n");
    ...
    {
        printf("Set Tx Msg Object 0 failed\n");
        return;
    }
    ...
    {
        printf("Set Tx Msg Object 1 failed\n");
        return;
    }
    ...
    {
        printf("Set Tx Msg Object 3 failed\n");
        return;
    }
