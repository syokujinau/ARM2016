...
//		ADC->ADCR.ADST=1;		     // restart ADC sample
		...
		if(0< ADC->ADDR[7].RSLT && ADC->ADDR[7].RSLT<=1000){
		show_seven_segment(4,0);
		}
		
		if(1000< ADC->ADDR[7].RSLT && ADC->ADDR[7].RSLT<=2000){
		show_seven_segment(4,1);
		}
		
		if(2000< ADC->ADDR[7].RSLT && ADC->ADDR[7].RSLT<=3000){
		show_seven_segment(4,2);
		}
		
		if(3000< ADC->ADDR[7].RSLT){
		show_seven_segment(4,3);
		}	
