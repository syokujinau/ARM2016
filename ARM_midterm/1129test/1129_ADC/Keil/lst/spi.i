#line 1 "..\\..\\..\\..\\Library\\NUC1xx\\Source\\SPI.c"
...
#line 1 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\NUC1xx.h"
...
#line 56 "..\\..\\..\\..\\Library\\CMSIS\\Include\\core_cm0.h"
...
#line 82 "..\\..\\..\\..\\Library\\CMSIS\\Include\\core_cm0.h"
...
#line 377 "..\\..\\..\\..\\Library\\CMSIS\\Include\\core_cm0.h"
...
#line 395 "..\\..\\..\\..\\Library\\CMSIS\\Include\\core_cm0.h"
...
#line 500 "..\\..\\..\\..\\Library\\CMSIS\\Include\\core_cm0.h"
...
#line 770 "..\\..\\..\\..\\Library\\CMSIS\\Include\\core_cm0.h"
...
#line 75 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\NUC1xx.h"
#line 1 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\system_NUC1xx.h"
...
#line 76 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\NUC1xx.h"
#line 1 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\SysInfra.h"
...
#line 1 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\ModuleID.h"
...
#line 15 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\SysInfra.h"
#line 16 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\SysInfra.h"
#line 17 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\SysInfra.h"
...
#line 77 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\NUC1xx.h"
...
#line 6629 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\NUC1xx.h"
...
#line 6685 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\NUC1xx.h"
...
#line 6703 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\NUC1xx.h"
...
#line 6756 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\NUC1xx.h"
...
#line 6782 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\NUC1xx.h"

#line 6789 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\NUC1xx.h"
...
#line 6835 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC1xx\\Include\\NUC1xx.h"


                                                                                                 
#line 12 "..\\..\\..\\..\\Library\\NUC1xx\\Source\\SPI.c"
#line 13 "..\\..\\..\\..\\Library\\NUC1xx\\Source\\SPI.c"
#line 1 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\SPI.h"
...
#line 10 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\SPI.h"
#line 11 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\SPI.h"
...
#line 14 "..\\..\\..\\..\\Library\\NUC1xx\\Source\\SPI.c"
#line 1 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\SYS.h"
...
#line 10 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\SYS.h"
...
#line 35 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\SYS.h"
...
#line 15 "..\\..\\..\\..\\Library\\NUC1xx\\Source\\SPI.c"
...
{
    uint8_t bInUse;
    PFN_DRVSPI_CALLBACK pfnOneTransDoneCallBack;  
...
{
    if( ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000))->CNTRL.IF == 1 )  
    {
        ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000))->CNTRL.IF = 1;    
    
        if(g_sSpiHandler[0].pfnOneTransDoneCallBack != 0)
        {
            g_sSpiHandler[0].pfnOneTransDoneCallBack(g_sSpiHandler[0].u32OneTransDoneUserData);
        }
    }
    
    if( ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000))->CNTRL2.SLV_START_INTSTS == 1 )  
    {
        ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000))->CNTRL2.SLV_START_INTSTS = 1;    
    
        if(g_sSpiHandler[0].pfn3WireStartCallBack != 0)
        {
...
{
    if( ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL.IF == 1 )  
    {
        ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL.IF = 1;    
    
        if(g_sSpiHandler[1].pfnOneTransDoneCallBack != 0)
        {
            g_sSpiHandler[1].pfnOneTransDoneCallBack(g_sSpiHandler[1].u32OneTransDoneUserData);
        }
    }
    
    if( ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL2.SLV_START_INTSTS == 1 )  
    {
        ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL2.SLV_START_INTSTS = 1;    
    
        if(g_sSpiHandler[1].pfn3WireStartCallBack != 0)
        {
...
{
    if( ((SPI_T *) ((( uint32_t)0x40100000) + 0x30000))->CNTRL.IF == 1 )  
    {
        ((SPI_T *) ((( uint32_t)0x40100000) + 0x30000))->CNTRL.IF = 1;    
    
        if(g_sSpiHandler[2].pfnOneTransDoneCallBack != 0)
        {
            g_sSpiHandler[2].pfnOneTransDoneCallBack(g_sSpiHandler[2].u32OneTransDoneUserData);
        }
    }
    
    if( ((SPI_T *) ((( uint32_t)0x40100000) + 0x30000))->CNTRL2.SLV_START_INTSTS == 1 )  
    {
        ((SPI_T *) ((( uint32_t)0x40100000) + 0x30000))->CNTRL2.SLV_START_INTSTS = 1;    
    
        if(g_sSpiHandler[2].pfn3WireStartCallBack != 0)
        {
...
{
    if( ((SPI_T *) ((( uint32_t)0x40100000) + 0x34000))->CNTRL.IF == 1 )  
    {
        ((SPI_T *) ((( uint32_t)0x40100000) + 0x34000))->CNTRL.IF = 1;    
    
        if(g_sSpiHandler[3].pfnOneTransDoneCallBack != 0)
        {
            g_sSpiHandler[3].pfnOneTransDoneCallBack(g_sSpiHandler[3].u32OneTransDoneUserData);
        }
    }
    
    if( ((SPI_T *) ((( uint32_t)0x40100000) + 0x34000))->CNTRL2.SLV_START_INTSTS == 1 )  
    {
        ((SPI_T *) ((( uint32_t)0x40100000) + 0x34000))->CNTRL2.SLV_START_INTSTS = 1;    
    
        if(g_sSpiHandler[3].pfn3WireStartCallBack != 0)
        {
...
int32_t DrvSPI_Open(E_DRVSPI_PORT eSpiPort, E_DRVSPI_MODE eMode, E_DRVSPI_TRANS_TYPE eType, int32_t i32BitLength)
{
    ...
    g_sSpiHandler[eSpiPort].pfnOneTransDoneCallBack = 0;
    g_sSpiHandler[eSpiPort].u32OneTransDoneUserData = 0;
    g_sSpiHandler[eSpiPort].pfn3WireStartCallBack = 0;
...
void DrvSPI_EnableInt(E_DRVSPI_PORT eSpiPort, PFN_DRVSPI_CALLBACK pfnCallback, uint32_t u32UserData)
{
    ...
    {
        NVIC_SetPriority(SPI3_IRQn, (1<<2) - 2);
