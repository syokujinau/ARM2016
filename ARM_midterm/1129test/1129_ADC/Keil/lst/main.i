...
#line 6 "..\\main.c"
#line 1 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\GPIO.h"
...
#line 10 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\GPIO.h"
...
#line 117 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\GPIO.h"
...
#line 8 "..\\main.c"
#line 1 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Include\\Scankey.h"
...
#line 9 "..\\main.c"
#line 1 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Include\\LCD.h"
...
void Tone(int x)
{
    ...
    switch(x){
        case 1:
        print_Line(0,"Do");
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = 21146;
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0*0.95;        
        ...
        case 2:
        print_Line(0,"Do#");
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = 19962;
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0*0.95;            
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=1;
        DrvSYS_Delay(10000);
        clear_LCD();
        ...
        case 3:
        print_Line(0,"Re");
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = 18840;
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0*0.95;       
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=1;
        DrvSYS_Delay(10000);
        clear_LCD();
        ...
        case 4:
        print_Line(0,"Re#");
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = 17780;
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0*0.95;       
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=1;
        DrvSYS_Delay(10000);
        clear_LCD();
        ...
        case 5:
        print_Line(0,"Me");
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = 16872;
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0*0.95;                      
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=1;
        DrvSYS_Delay(10000);
        clear_LCD();
        ...
        case 6:
        print_Line(0,"Fa");
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = 15844;
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0*0.95;                       
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=1;
        DrvSYS_Delay(10000);
        clear_LCD();
        ...
        case 7:
        print_Line(0,"Fa#");
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = 14945;
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0*0.95;                       
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=1;
        DrvSYS_Delay(10000);
        clear_LCD();
        ...
        case 8:
        print_Line(0,"So");
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = 14106;
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0*0.95;                     
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=1;                       
        DrvSYS_Delay(10000);
        clear_LCD();
        ...
        case 9:
        print_Line(0,"So#");
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 =13308;
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0*0.95;                    
        ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=1;
        DrvSYS_Delay(10000);
        clear_LCD();
        ...
        default:((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=0;
    }
...
void InitADC(void)
{
    ...
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->OFFD|=0x00800000;    
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.ADC7_SS21_AD6=1;        
                
               
    ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.ADC_S = 2;  
    ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV.ADC_N = 1;   
    ...
    ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCHER.CHEN = 0x80;
    
     
    ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADSR.ADF =1;           
...
int32_t main (void)
{
    ...
    *((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x59;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x16;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x88;
    ...
    ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0.HCLK_S = 7;   
    *((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
    ...
    ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = 89;  
    ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = 44;   
    
    while(1)
    {
        int resistance,l;
        resistance = ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[7].RSLT;
        l = resistance/1000;
        Tone(1);
        delay02X(l+1);
              Tone(4);
