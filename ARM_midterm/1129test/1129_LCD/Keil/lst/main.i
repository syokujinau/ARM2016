...
#line 9 "..\\main.c"
#line 1 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\UART.h"
...
#line 10 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\UART.h"
...
#line 46 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\UART.h"
...
int32_t main ()
{
    ...
    *((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
    ...
    while(1)
    {
        sprintf(TEXT,"NCHU NO%d",count1);
        print_Line(0, TEXT);
        sprintf(TEXT,"NCHU NO%d",count2);
        print_Line(1, TEXT);
        sprintf(TEXT,"NCHU NO%d",count3);
        print_Line(2, TEXT);
        sprintf(TEXT,"NCHU NO%d",count4);
        print_Line(3, TEXT);
