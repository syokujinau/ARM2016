...
void InitTIMER0(void)
{
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.TMR0_S = 1;	
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCMPR = 128;		    
...
void InitTIMER1(void)
{
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.TMR1_S = 1;	
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TCSR.PRESCALE = 255;	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TCMPR = 128;		    
